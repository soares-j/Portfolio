        ...
        cards: [
            {
                ...
                desc: "This web project was developed as part of a personal initiative to design and showcase a game character. It serves as a practical exercise to strengthen and consolidate my web development skills. Making part of the beginning of my academic journey.",
        ...
        projectsCards.innerHTML = langObj.cards.map((card, idx) => `
            <div class="project-block">
                ...
                <div style="text-align:center;">
                    <a href="${idx === 0 
                        ? 'https://gragas.site' 
                        : 'https://github.com/soares-j/cryptography-python'}" target="_blank">
